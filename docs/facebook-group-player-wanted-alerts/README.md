...
The web page for the [Facebook Group: Player Wanted Alerts](https://github.com/drewbroadley/unashamedai/tree/main/chrome-extensions/facebook-group-player-wanted-alerts)
Chrome extension, live at
[unashamedai.broadley.org.nz/facebook-group-player-wanted-alerts/](https://unashamedai.broadley.org.nz/facebook-group-player-wanted-alerts/).
